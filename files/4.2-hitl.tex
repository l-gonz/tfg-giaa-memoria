...
\todo[inline]{Edit for new battery}
...
This can be disabled through the \texttt{raspi-config} command-line utility (Advanced config -> Serial -> Disable\todo{Check option path on latest OS}).
