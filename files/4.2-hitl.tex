...
With these measurements, it is possible to form an idea of how the board will behave during real flight, with the last test being the closest to the expected flight conditions.
