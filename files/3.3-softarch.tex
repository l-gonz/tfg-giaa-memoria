...
Figure \ref{fig:architecture} shows the main modules the designed software is composed of and how it interacts with the external libraries.
...
\todo[inline]{Draw: hand loop diagram}
\begin{figure}
  \centering
  \includegraphics[width=8cm, keepaspectratio]{img/placeholder.png}
  \caption{Execution flow for the hand-gesture control solution.}
...
\todo[inline]{Draw: follow loop diagram}
\begin{figure}
  \centering
  \includegraphics[width=8cm, keepaspectratio]{img/placeholder.png}
  \caption{Vector calculations}
...
These tools are used in section \ref{sec:test-1-pid} to set the correct values in the coefficients for the controllers empirically.
