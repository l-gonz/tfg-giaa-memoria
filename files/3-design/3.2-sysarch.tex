...
In addition, the Raspberry Pi’s officially supported operating
system, called Raspbian, is a Debian-based version of Unix, which simplifies the transition from the WSL test environment.
