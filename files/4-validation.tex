...
´\todo[inline]{Video: record tune tool}
...
%%%%%%%%% [here] %%%%%%%%
\todo{Video: record test-controller tool}
...
\todo[inline]{Test: rerun validation tool for fwd}
\todo[inline]{Write: finish explanation for latest graph}
...
\begin{figure}
  ...
  \caption{Follow solution running with the tuned PID controllers}
  \label{fig:validate-fwd}
\end{figure}

A video of the full follow solution running with the appropriate tunings for the controllers can be seen in here.
%%%%%%%%%%%% [HERE] %%%%%%%%%%%%
