...
\end{figure}
\todo[inline]{Cite}
% https://docs.px4.io/main/en/frames_multicopter/holybro_x500_pixhawk4.html#holybro-x500-pixhawk4-build
...
\begin{figure}
  \centering
  \includegraphics[width=0.7\textwidth,keepaspectratio]{img/rpi4b.jpg}
  \caption{Raspberry Pi 4 Model B. Image by OKdo}\label{fig:rpi4b}
\end{figure}
\todo[inline]{Cite}
% \url{https://www.okdo.com/p/raspberry-pi-4-model-b-8gb-ram/}
