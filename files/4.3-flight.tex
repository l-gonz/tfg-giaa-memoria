...
The full video of the test can be seen in link \todo{Fly-Video: Make video and link}.
...
The terminal and camera output can be seen in figure \ref{fig:flight-test-cam-onboard} and a video recording the remote desktop during the flight can be seen in link \todo{Fly-video: Link video of screen during onboard test-camera flight}.
...
\todo[inline]{Fly-config: Make return home altitude less before flying}

\todo[inline]{Fly-Video: Video should show side-by-side computer screen with terminal and image output and video from vehicle flying, synced}
...
\todo[inline]{Fly-Write: Save performance for flight tests, add measure tables in each section}
\todo[inline]{Fly-video: Same recording as hand sec}
