...
% INTRODUCTION %
\include{files/1-intro}

% ESTADO DEL ARTE %
\chapter{State of the art}
\label{chap:sota}
\include{files/2.1-literature}
\include{files/2.2-tech}
\cleardoublepage

% DISEÑO E IMPLEMENTACIÓN %
\chapter{Design and implementation}
\label{chap:design}
\include{files/3.1-devenv}
\include{files/3.2-sysarch}
\include{files/3.3-softarch}
\cleardoublepage

% EXPERIMENTOS Y VALIDACIÓN %
\include{files/4-validation}

% CONCLUSIONES %
\include{files/5-conclusion}
