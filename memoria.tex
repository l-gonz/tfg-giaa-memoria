...
\label{chap:sota}
\include{files/1-2-intro/2.1-literature}
\include{files/1-2-intro/2.2-tech}
\cleardoublepage

% DISEÑO E IMPLEMENTACIÓN %
\chapter{Design and implementation}
\label{chap:design}
\include{files/3-design/3.1-devenv}
\include{files/3-design/3.2-sysarch}
\include{files/3-design/3.3-softarch}
\cleardoublepage

% EXPERIMENTOS Y VALIDACIÓN %
\include{files/4-validation/4-validation}

% CONCLUSIONES %
\include{files/5-6-end/5-conclusion}
